...
//TFile *f = TFile::Open("root://eospublic.cern.ch//eos/opendata/cms/derived-data/NanoAODRun1/01-Jul-22/Run2011A_SingleMu/94000E51-36DE-4AE5-939B-12EE231D9755.root"); dobavih i vtoriq file s danni,koito skusih
//TFile *f = TFile::Open("total_data.root");

TFile *f = TFile::Open("MCdata.root");
...
//Histograms definitions
 ...
 // x: pT на муона (0-200 GeV), y: MET pt (0-200 GeV)
  ...
  TH1F *hW_Mass = new TH1F("hW_Mass", "W  Mass (TLorentzVector);M_{T} [GeV];Events", 100, 0, 150);//С Тлоренц
...
//    if (ptMu > 25.0 && met > 25.0) {
   ...
   hW_Mass->Fill(mTW_Lorentz);	//ne e transverse
